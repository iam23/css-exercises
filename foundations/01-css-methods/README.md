...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? no
- Did you properly link the external CSS file in the HTML file?
- Does the `div` element have CSS added via the external method? no
- Does the `p` element have CSS added via the internal method? no
